...
const balance = expenses.transport - expenses.food - expenses.food - rent[type]; // Create a new variable balance from items fetched from the expense object using .notation and the string valuable
